...
class FeedforwardNN():
    ...
    def __init__(self, input_dim):
        ...
        layer = Dense(6, activation='tanh', kernel_initializer=initializers.RandomNormal()) (input_layer)

        layer = Dense(2, activation='tanh', kernel_initializer=initializers.RandomNormal()) (layer)
